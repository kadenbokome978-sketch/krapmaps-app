/**
 * NEXUS → Greenlit state endpoint (Vercel serverless function).
 *
 * Lets NEXUS/Hermes query Greenlit's current project state from Supabase.
 * Authenticated with NEXUS_INBOUND_TOKEN — only the NEXUS relay holds this.
 * Returns a structured summary of current content pipeline, performance,
 * and project context. Never exposes raw Supabase credentials.
 */
