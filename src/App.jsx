            ...
            {videos.length===0
              ...
              : (
                <div style={{ background:C.card, border:`1px solid ${C.border}`, borderRadius:14, overflow:"hidden" }}>
                  <div style={{ display:"grid", gridTemplateColumns:"1fr 60px 70px 65px 55px 36px", padding:"8px 14px", background:C.pinkBg, color:C.dim, fontSize:9, fontWeight:700, letterSpacing:"0.1em", gap:6, fontFamily:"'Syne',sans-serif" }}>
                  ...
                  {sortedVideos.map((v,i)=>{
                    ...
                    return (
                      <div key={v.id} style={{ display:"grid", gridTemplateColumns:"1fr 60px 70px 65px 55px 36px", padding:"10px 14px", borderBottom:`1px solid ${C.border}`, gap:6, alignItems:"center", background:i===0?C.pinkBg:"transparent" }}>
                        ...
                        <button onClick={()=>deleteVideo(v.id)} style={{ background:"#FF2D7822", border:"1px solid #FF2D7844", borderRadius:6, color:"#FF2D78", cursor:"pointer", fontSize:13, padding:"2px 6px", fontWeight:700 }}>✕</button>
                      </div>
                    );
                  })}
                </div>
