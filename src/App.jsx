              ...
              : (
                <>
                  ...
                  <div style={{ background:C.card, border:`1px solid ${C.pink}30`, borderRadius:16, padding:"20px", position:"relative", overflow:"hidden" }}>
                    ...
                    <div style={{ color:C.text, fontSize:16, fontWeight:700, fontFamily:C.fontBody, lineHeight:1.5, marginBottom:14 }}>{analysis.keyPattern}</div>
                  ...
                  <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:10 }}>
                    {[{label:"HOOK",data:analysis.hookAnalysis,bk:"bestHook",wk:"worstHook",color:C.cyan},{label:"FORMAT",data:analysis.typeAnalysis,bk:"bestType",wk:"worstType",color:C.green}].map(({label,data,bk,wk,color})=>(
                      <div key={label} style={{ background:C.card, border:`1px solid ${color}20`, borderRadius:14, padding:"16px" }}>
                        ...
                        <div style={{ color:C.dim, fontSize:11, lineHeight:1.5, fontFamily:C.fontBody }}>{data?.reasoning}</div>
                      </div>
                    ))}
                  </div>
                  {/* Working / Not Working */}
                      ...
                      <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-start", marginBottom:14, gap:10 }}>
                        <div style={{ flex:1 }}>
                          <div style={{ display:"flex", gap:6, alignItems:"center", marginBottom:6 }}>
                            <div style={{ color:C.dim, fontSize:9, letterSpacing:"0.12em", fontFamily:C.fontBody, fontWeight:700, textTransform:"uppercase" }}>{v.priority}</div>
                            <Tag color={C.pink} size={9}>{v.type}</Tag>
                            <Tag color={C.cyan} size={9}>{v.hook}</Tag>
                          </div>
                          <div style={{ color:C.text, fontSize:15, fontWeight:700, fontFamily:C.fontBody, lineHeight:1.4 }}>{v.title}</div>
                        </div>
              ...
              : (
                <>
                  ...
                  <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:10 }}>
                    ...
                    {weekly.biggestLearning && (
                      <div style={{ background:C.card, border:`1px solid ${C.cyan}25`, borderRadius:14, padding:"16px" }}>
                        ...
                        <div style={{ color:C.text, fontSize:13, lineHeight:1.5, fontFamily:C.fontBody }}>{weekly.biggestLearning}</div>
                      </div>
                    )}
                  </div>
                  {/* Target */}
                  ...
                  <div style={{ background:C.card, border:`1px solid ${C.green}25`, borderRadius:16, padding:"18px" }}>
                    ...
                    <div style={{ background:C.cardAlt, borderRadius:10, padding:"14px 16px", color:C.textMed, fontSize:13, lineHeight:1.8, fontFamily:C.fontBody, whiteSpace:"pre-wrap" }}>{weekly.rawSummaryText}</div>
                  </div>
                </>
              )
            }
                      ...
                      <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-start", gap:10, marginBottom:12 }}>
                        <div style={{ flex:1 }}>
                          <div style={{ display:"flex", gap:6, alignItems:"center", flexWrap:"wrap", marginBottom:6 }}>
                            <div style={{ color:C.text, fontSize:14, fontWeight:700, fontFamily:C.fontBody }}>{t.trend}</div>
