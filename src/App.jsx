...
const ContentView = ({ ideas, setIdeas, calItems, setCalItems, scoreIdea, genCaption, aiLoad, captionResult, captionIdea, copied, copyText, openModal, setEditIdeaTarget, setModals, setSub }) => {
            ...
            return (
              <Glass key={idea.id} glow={ic} style={{ padding:"14px" }}>
                ...
                <div style={{ display:"flex", gap:6, flexWrap:"wrap", alignItems:"center" }}>
                  ...
                  <ActionBtn color={C.cyan} onClick={()=>{ setSub&&setSub("CALENDAR"); openModal&&openModal("addCal"); }}>SCHEDULE</ActionBtn>
          ...
          {igData ? (
            <>
              <div style={{ display:"grid", gridTemplateColumns:"repeat(2,1fr)", gap:8 }}>
                ...
                <StatMini label="AVG REEL VIEWS" value={fmt((()=>{const r=igData.media?.filter(p=>p.media_type==="VIDEO");return r?.length?Math.round(r.reduce((s,p)=>s+(p.video_views||p.plays||0),0)/r.length):0;})()} color={C.cyan} icon={I.eye(13,C.cyan)} />
