...
function Dashboard({ keys, onEditKeys }) {
  ...
  useEffect(()=>{ saveJSON(TASKS_KEY,tasks); sbSet("km_tasks",tasks); },[tasks]);
  useEffect(()=>{ saveJSON(APPIDEAS_KEY,appIdeas); sbSet("km_appideas",appIdeas); },[appIdeas]);
  ...
  useEffect(()=>{
    async function loadFromSupabase() {
      ...
      if(tk) { try { const parsed=JSON.parse(tk); if(parsed.length>0) setTasks(parsed); } catch{} }
      if(ai) { try { const parsed=JSON.parse(ai); if(parsed.length>0) setAppIdeas(parsed); } catch{} }
    ...
    return (
      <div style={{ display:"flex", flexDirection:"column", gap:16 }}>
        ...
        {activeSub==="calendar" && (()=>{
          ...
          <div style={{ display:"flex", flexDirection:"column", gap:12 }}>
            <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center" }}>
              <div style={{ color:C.text, fontSize:22, fontWeight:400, fontFamily:C.fontHead, letterSpacing:"0.06em" }}>Content Calendar</div>
        ...
        {activeSub==="ideas" && (
          <div style={{ display:"flex", flexDirection:"column", gap:12 }}>
            <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center" }}>
              <div style={{ color:C.text, fontSize:22, fontWeight:400, fontFamily:C.fontHead, letterSpacing:"0.06em" }}>Idea Bank ({ideas.length})</div>
        ...
        {activeSub==="captions" && (
          <div style={{ display:"flex", flexDirection:"column", gap:14 }}>
            <div style={{ color:C.text, fontSize:22, fontWeight:400, fontFamily:C.fontHead, letterSpacing:"0.06em" }}>Caption Generator</div>
      ...
      <div style={{ display:"flex", flexDirection:"column", gap:16 }}>
        ...
        {activeSub==="analysis" && (
          <div style={{ display:"flex", flexDirection:"column", gap:10 }}>
            <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center" }}>
              <div style={{ color:C.text, fontSize:22, fontWeight:400, fontFamily:C.fontHead, letterSpacing:"0.06em" }}>What's Working</div>
        ...
        {activeSub==="nextVids" && (
          <div style={{ display:"flex", flexDirection:"column", gap:10 }}>
            <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center" }}>
              <div style={{ color:C.text, fontSize:22, fontWeight:400, fontFamily:C.fontHead, letterSpacing:"0.06em" }}>Next 3 Videos</div>
        ...
        {activeSub==="weekly" && (
          <div style={{ display:"flex", flexDirection:"column", gap:10 }}>
            <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center" }}>
              <div style={{ color:C.text, fontSize:22, fontWeight:400, fontFamily:C.fontHead, letterSpacing:"0.06em" }}>Harley Brief</div>
        ...
        {activeSub==="trends" && (
          <div style={{ display:"flex", flexDirection:"column", gap:10 }}>
            <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center" }}>
              <div style={{ color:C.text, fontSize:22, fontWeight:400, fontFamily:C.fontHead, letterSpacing:"0.06em" }}>Trend Analysis</div>
  ...
  const TasksView = () => {
    ...
    return (
      <div style={{ display:"flex", flexDirection:"column", gap:14 }}>
        {/* Header */}
        <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center" }}>
          <div style={{ color:C.text, fontSize:22, fontWeight:400, fontFamily:C.fontHead, letterSpacing:"0.06em" }}>TASKS & IDEAS</div>
  ...
  const GrowthView = () => (
    <div style={{ display:"flex", flexDirection:"column", gap:14 }}>
      <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center" }}>
        <div style={{ color:C.text, fontSize:22, fontWeight:400, fontFamily:C.fontHead, letterSpacing:"0.06em" }}>Growth Stats</div>
  ...
  const SettingsView = () => (
    <div style={{ display:"flex", flexDirection:"column", gap:16 }}>
      <div style={{ color:C.text, fontSize:22, fontWeight:400, fontFamily:C.fontHead, letterSpacing:"0.06em" }}>Settings</div>
