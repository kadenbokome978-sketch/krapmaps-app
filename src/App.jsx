...
const KEYS_KEY    = "krapmaps_v39_config";
const MANUAL_KEY  = "krapmaps_v39_manual";
const VIDEOS_KEY  = "krapmaps_v39_videos";
const IDEAS_KEY   = "krapmaps_v39_ideas";
const CAL_KEY     = "krapmaps_v39_calendar";
const TRENDS_KEY  = "krapmaps_v39_trends";
const TASKS_KEY   = "krapmaps_v39_tasks";
const APPIDEAS_KEY = "krapmaps_v39_appideas";

const SYNC_KEY   = "krapmaps_v39_syncurl";
    ...
    return (
      <div style={{ display:"flex", flexDirection:"column", gap:16 }}>
        ...
        {activeSub==="videos" && (
          <div style={{ display:"flex", flexDirection:"column", gap:10 }}>
            <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center" }}>
              <div style={{ color:C.text, fontSize:20, fontWeight:400, fontFamily:C.fontHead, letterSpacing:"0.02em" }}>Videos</div>
