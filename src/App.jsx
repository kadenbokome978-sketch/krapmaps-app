                  ...
                  {sortedVideos.map((v,i)=>{
                    ...
                    return (
                      <div key={v.id} style={{ display:"flex", flexDirection:"column" }}>
                        <div style={{ display:"grid", gridTemplateColumns:D.phone?"2fr 45px 45px 40px 36px":"1fr 55px 65px 60px 55px 36px", padding:D.phone?"10px 10px":"12px 16px", borderBottom:ps?`1px solid ${C.border}40`:`1px solid ${C.border}`, gap:D.phone?4:8, alignItems:"center", background:i===0?C.pink+"08":"transparent" }}>
                          <div>
                            <div style={{ color:C.text, fontSize:D.phone?11:12, fontFamily:C.fontBody, fontWeight:600, marginBottom:3, lineHeight:1.3, overflow:"hidden" }}>{i===0&&<span style={{ color:C.yellow, marginRight:4 }}>{Icon.star}</span>}{v.title}{ps&&<span style={{ background:ps.score>=65?C.green+"25":ps.score>=50?C.yellow+"25":C.pink+"25", color:ps.score>=65?C.green:ps.score>=50?C.yellow:C.pink, fontSize:8, marginLeft:5, padding:"1px 6px", borderRadius:4, fontFamily:C.fontBody, fontWeight:700, letterSpacing:"0.06em" }}>{ps.label}</span>}</div>
                        ...
                        {ps && (
                          <div style={{ background:`linear-gradient(135deg,${ps.score>=65?C.green:ps.score>=50?C.yellow:C.pink}08,transparent)`, borderBottom:`1px solid ${C.border}`, padding:"10px 14px" }}>
                            <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:8 }}>
                              ...
                              <div style={{ display:"flex", alignItems:"baseline", gap:4 }}>
                                <div style={{ color:ps.score>=65?C.green:ps.score>=50?C.yellow:C.pink, fontSize:28, fontWeight:400, fontFamily:C.fontHead, lineHeight:1 }}>{ps.score}</div>
